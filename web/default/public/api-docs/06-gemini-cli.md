...
进入网站 https://pydaxing.com 进行注册并充值，然后在“令牌管理”页面，复制apikey，后续需要用到。
...
```bash
GOOGLE_GEMINI_BASE_URL=https://pydaxing.com/
```

如果不成功，将`GOOGLE_GEMINI_BASE_URL`改成`https://pydaxing.com`
